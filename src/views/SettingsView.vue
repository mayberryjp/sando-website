...
const configurationDefinitions: ConfigurationDefinition[] = [
  ...
  },
  {
    ...
    default: "",
    suggested: "Configure a Discord webhook URL for the channel that should receive notifications.",
  },
  // Processes
  {
    category: "Processes",
  ...
  },
  {
    ...
    {
    category: "Processes",
    displayName: "DHCP Passive Monitoring",
    type: "Boolean/Toggle",
    key: "DhcpPassiveMonitoring",
    details: "Enable or disable passive monitoring of DHCP traffic. If you have another DHCP Server on your network, you can enable this to monitor DHCP traffic and detect new devices without interfering with the existing DHCP server.",
    default: "Disabled",
    suggested: "Disabled",
  },
  {
  ...
  {
    category: "Processing",
    displayName: "DNS Fetch Interval",
    type: "Text/Int",
    key: "PiHoleDnsFetchInterval",
    details: "Frequency in seconds at which the DNS fetch process runs to store what DNS queries the hosts on your network are making. AdGuard and PiHole are supported.",
    default: "3600",
    suggested: "3600 (1 hour)",
  },
  {
    category: "Processing",
    displayName: "DNS Fetch Record Size",
    type: "Text/Int",
    key: "PiHoleDnsFetchRecordSize",
    details: "Number of DNS records to fetch from DNS in each request. This is used to limit the amount of data fetched in each request. AdGuard and PiHole are supported.",
    default: "10000",
  ...
  },
  {
    ...
    type: "Text/String",
    key: "PiholeApiKey",
    details: "API key for the PiHole instance to authenticate requests. This is required to access the PiHole API. Only PiHole v6 is supported.",
    default: "",
    suggested: "Your PiHole API key from your local pihole instance",
  },
    {
    category: "Discovery",
    displayName: "AdGuard URL",
    type: "Text/String",
    key: "AdGuardUrl",
    details: "URL of the AdGuard instance to fetch DNS query history and other data from. This is used to integrate with AdGuard for DNS query history.",
    default: "",
    suggested: "http://localhost:80",
  },
  {
    category: "Discovery",
    displayName: "AdGuard Username",
    type: "Text/String",
    key: "AdGuardUsername",
    details: "Username for the AdGuard instance to authenticate requests. This is required to access the AdGuard API.",
    default: "",
    suggested: "Your AdGuard username from your local AdGuard instance",
  },
    {
    category: "Discovery",
    displayName: "AdGuard Password",
    type: "Text/String",
    key: "AdGuardPassword",
    details: "Password for the AdGuard instance to authenticate requests. This is required to access the AdGuard API.",
    default: "",
    suggested: "Your AdGuard password from your local AdGuard instance",
  },
  {
    category: "Discovery",
    ...
    details: "Enable or disable reverse DNS lookups for local device discovery. This helps identify the hostnames of devices on your local network. Used as a reverse DNS auditing tool and will create an action if a host doesn't have reverse DNS.",
    default: "Disabled",
    suggested: "Enabled",
  },
  {
  ...
  },
  {
    ...
    {
    category: "Discovery",
    displayName: "Store AdGuard DNS Query History",
    type: "Boolean/Toggle",
    key: "StoreAdGuardDnsQueryHistory",
    details: "Enable or disable the storage of AdGuard DNS query history. This helps in tracking DNS queries made by devices on your network.",
    default: "Disabled",
    suggested: "Enabled",
  },
  {
